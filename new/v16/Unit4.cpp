...
void __fastcall TForm4::Button3Click(TObject *Sender)
{
      ...
      name_institutions_job += Form4->ADOQuery1->FieldByName("name_institutions_job")->AsString+";";
      ...
      call_specialized_academic_council += Form4->ADOQuery1->FieldByName("call_specialized_academic_council")->AsString+";";

      // Найменування установи, в якій відбудеться захист
      name_institutions_protect = "Найменування установи, в якій відбудеться захист;";
      name_institutions_protect += Form4->ADOQuery1->FieldByName("name_institutions_protect")->AsString+";";

      // Адреса установи, в якій відбудеться захист
      address_institutions_protected = "Адреса установи, в якій відбудеться захист;";
      address_institutions_protected += Form4->ADOQuery1->FieldByName("address_institutions_protected")->AsString+";";
      ...
      oficial += Form4->ADOQuery1->FieldByName("oficial")->AsString+";";
